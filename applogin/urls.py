...
urlpatterns = [
    ...
    path("ParentRegistrationView",ParentRegistrationView.as_view(),name='ParentRegistrationView'),
    ...
    path('classrooms/<int:classroom_id>/addstudents', AddStudentsToClassroomAPIView.as_view(), name='add-students'),
#     {
#     "student_ids": [1, 2, 3, 4]
# } 
    ...
    path('classrooms/<classroom_id>/<int:task_id>/tasks/',ClassroomTasksView1.as_view(),name='ClassroomTasksView'),
    ...
    path('studentclassrooms/<int:classroom_id>', ClassroomStudentsView.as_view(), name='classroom-students'),
    #add students to parents
    path('parents/<int:parent_id>/addstudents', AddStudentsToParentView.as_view(), name='add-students-to-parent'),
    #{
#     "student_ids": [2, 3, 5]
# }
    #view students in each parent
    path('parent/<int:parent_id>/students/', ParentStudentsView.as_view(), name='parent-students'),
    ...
    path('excluded-students/<int:classroom_id>/', ExcludedStudentsAPIView.as_view(), name='excluded-students'),
